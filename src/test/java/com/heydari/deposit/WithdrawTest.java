...
public class WithdrawTest {
    ...
    //===========================================================================
    @Test
    public void withdraw_Method_Test_Happy_Scenario() throws DepositCreateException, DepositInternalException {
        ...
        Deposit retDeposit = depositService.withdraw (depositOperationBase, false);
        assertEquals(deposit.getId() , retDeposit.getId());

    }
    //===========================================================================
    @Test
    public void withdraw__Test_Test_ByNull_Paramet()  {
        assertThrows( DepositInternalException.class, () -> depositService.withdraw (null, false));
    }
